package com.dkjk.search.swagger;
...
/*        //在配置好的配置类中增加此段代码即可
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Elasticsearch-Api").termsOfServiceUrl("https://git.oschina.net/suntea")
                .contact(new Contact("DKJK", "http://www.daokoujinke.com", "oog@163.com")).version("1.0.0").build();
    }

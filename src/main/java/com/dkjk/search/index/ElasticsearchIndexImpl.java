package com.dkjk.search.index;

import com.dkjk.search.util.IndexTools;
import com.dkjk.search.util.MappingData;
import com.dkjk.search.util.MetaData;
...
public class ElasticsearchIndexImpl<T> implements ElasticsearchIndex<T> {
    ...
    public void createIndex(Class<T> clazz) throws Exception{
        ...
        /*request.mapping(metaData.getIndextype(),//类型定义
                ...
                XContentType.JSON);*/
        request.mapping(source.toString(),//类型映射，需要的是一个JSON字符串
                XContentType.JSON);
        try {
